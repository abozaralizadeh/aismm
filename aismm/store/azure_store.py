...
class AzureStore(Store):
    ...
    def _instruction_to_entity(i: Instruction) -> dict:
        return {
            ...
            "last_video_style": i.last_video_style,
            ...
            "youtube_made_for_kids": i.youtube_made_for_kids,
    ...
    def _instruction_from_entity(e) -> Instruction:
        return Instruction(
            ...
            video_style=e.get("video_style", ""),
            last_video_style=e.get("last_video_style", ""),
            ...
            youtube_made_for_kids=e.get("youtube_made_for_kids", ""),
